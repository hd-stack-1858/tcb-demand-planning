...
#
# Usage: ./scripts/gcp/deploy_growthspurt.sh PROJECT_ID
#
# Builds Dockerfile.webapp for linux/amd64, pushes to Artifact Registry, and
# deploys (or updates) the tcb-growthspurt Cloud Run service.
#
# Prerequisites:
...
PROJECT_ID="${1:?Usage: deploy_growthspurt.sh PROJECT_ID}"

REGION=asia-south1
REPO=tcb-spike
SERVICE=tcb-growthspurt
IMAGE="asia-south1-docker.pkg.dev/${PROJECT_ID}/${REPO}/growthspurt:latest"
