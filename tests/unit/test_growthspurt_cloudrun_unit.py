"""Contract tests for the Growth Spurt Cloud Run deploy script (issue #116, epic #113).
...
STREAMLIT_APP=growthspurt_app.py, lock down access with
...
def test_targets_correct_service_name():
    assert "SERVICE=tcb-growthspurt" in _script_text()
